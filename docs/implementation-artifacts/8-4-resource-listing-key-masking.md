...
- 管理接口与脱敏逻辑集中在 [server.rs](file:///Users/shawn/workspace/code/apex/src/server.rs)。
- admin 列表测试集中在 [gateway.rs](file:///Users/shawn/workspace/code/apex/tests/gateway.rs)。
...
- [E08-MCP-Server.md](file:///Users/shawn/workspace/code/apex/docs/epics/E08-MCP-Server.md#L36-L43)
- [project-development-constraints.md](file:///Users/shawn/workspace/code/apex/.trae/rules/project-development-constraints.md#L15-L20)
