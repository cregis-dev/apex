...
docs/
├── index.md                # 文档索引 (新生成)
├── project-overview.md     # 项目概览 (新生成)
├── PRD.md                  # 产品需求文档
├── architecture.md         # 架构设计
├── operations.md           # 操作手册
├── config-example.md       # 配置示例说明
├── LOGGING_SPEC.md         # 日志规范
├── WORKFLOW.md             # 工作流说明
├── STORY-web-dashboard.md  # Web Dashboard 开发故事
├── epics/                  # Epic 文档
│   ├── E01-Core-Gateway.md
│   ├── E02-Advanced-Routing.md
│   ├── E03-CLI-Management.md
│   ├── E04-Observability.md
│   ├── E05-Rule-Based-Routing.md
│   ├── E06-Team-Governance.md
│   ├── E07-Data-Compliance.md
│   └── E08-MCP-Server.md
...
│   ├── tech-spec-openai-responses-api.md
│   └── tech-spec-dashboard-heatmap.md
└── test-artifacts/         # 测试产物
