...
files_to_modify:
  - '/Users/shawn/workspace/coding/apex/web/src/components/dashboard/dashboard-client.tsx'
  - '/Users/shawn/workspace/coding/apex/web/src/components/dashboard/'
  - '/Users/shawn/workspace/coding/apex/web/src/app/globals.css'
  - '/Users/shawn/workspace/coding/apex/web/src/components/ui/tabs.tsx'
  - '/Users/shawn/workspace/coding/apex/web/src/components/ui/'
  - '/Users/shawn/workspace/coding/apex/web/tests/dashboard.spec.ts'
  - '/Users/shawn/workspace/coding/apex/src/server.rs'
  - '/Users/shawn/workspace/coding/apex/src/database.rs'
  - '/Users/shawn/workspace/coding/apex/src/mcp/analytics.rs'
code_patterns:
...
- 当前 dashboard 主实现集中在 [`/Users/shawn/workspace/coding/apex/web/src/components/dashboard/dashboard-client.tsx`](/Users/shawn/workspace/coding/apex/web/src/components/dashboard/dashboard-client.tsx)，由单个客户端组件维护时间范围、筛选、URL query、导出、表格、认证和图表数据。
- Dashboard 页面入口极薄，只在 [`/Users/shawn/workspace/coding/apex/web/src/app/dashboard/page.tsx`](/Users/shawn/workspace/coding/apex/web/src/app/dashboard/page.tsx) 中渲染 `DashboardClient`，因此重构优先方向应是拆分 `dashboard-client.tsx` 为更小的业务组件，而不是改 `page.tsx` 路由结构。
...
- `src/database.rs` 已有 `get_usage_records_for_analytics` 和 `UsageRecordQuery`，而 [`/Users/shawn/workspace/coding/apex/src/mcp/analytics.rs`](/Users/shawn/workspace/coding/apex/src/mcp/analytics.rs) 已经基于它做记录级聚合，这为 dashboard 新增团队、渠道、模型、拓扑类统计提供了复用锚点。
- 发布链路已经满足“可打包进二进制”的要求：前端继续导出到 `target/web`，Rust 通过 `embedded-web` feature 从 [`/Users/shawn/workspace/coding/apex/src/web_assets.rs`](/Users/shawn/workspace/coding/apex/src/web_assets.rs) 嵌入并提供静态资源，因此本次允许重构前端架构，但不能破坏 `target/web` 输出和静态 export 约束。

### Files to Reference

| File | Purpose |
| ---- | ------- |
| [/Users/shawn/workspace/coding/apex/web/src/components/dashboard/dashboard-client.tsx](/Users/shawn/workspace/coding/apex/web/src/components/dashboard/dashboard-client.tsx) | 当前 dashboard 核心实现，包含认证、筛选、图表、records 表格、导出和 URL 状态 |
| [/Users/shawn/workspace/coding/apex/web/src/app/dashboard/page.tsx](/Users/shawn/workspace/coding/apex/web/src/app/dashboard/page.tsx) | Dashboard 页面入口 |
| [/Users/shawn/workspace/coding/apex/web/src/app/globals.css](/Users/shawn/workspace/coding/apex/web/src/app/globals.css) | 全局主题变量与基础样式，需要承载新的 Slate/Emerald/Orange 视觉方向 |
| [/Users/shawn/workspace/coding/apex/web/src/components/ui/select.tsx](/Users/shawn/workspace/coding/apex/web/src/components/ui/select.tsx) | 当前可直接复用的筛选器 primitive |
| [/Users/shawn/workspace/coding/apex/web/src/components/ui/chart.tsx](/Users/shawn/workspace/coding/apex/web/src/components/ui/chart.tsx) | 统一图表容器、tooltip 和图例样式能力 |
| [/Users/shawn/workspace/coding/apex/web/package.json](/Users/shawn/workspace/coding/apex/web/package.json) | 确认 Next.js、Recharts、Playwright 与构建输出脚本 |
| [/Users/shawn/workspace/coding/apex/web/next.config.ts](/Users/shawn/workspace/coding/apex/web/next.config.ts) | 静态导出与 trailing slash 约束 |
| [/Users/shawn/workspace/coding/apex/src/server.rs](/Users/shawn/workspace/coding/apex/src/server.rs) | Dashboard 静态资源挂载与 API 路由整合点 |
| [/Users/shawn/workspace/coding/apex/src/middleware/auth.rs](/Users/shawn/workspace/coding/apex/src/middleware/auth.rs) | Dashboard 使用的全局鉴权模型 |
| [/Users/shawn/workspace/coding/apex/src/database.rs](/Users/shawn/workspace/coding/apex/src/database.rs) | 现有 usage、metrics、trends、rankings SQL 以及 analytics 查询锚点 |
| [/Users/shawn/workspace/coding/apex/src/mcp/analytics.rs](/Users/shawn/workspace/coding/apex/src/mcp/analytics.rs) | 已存在的记录聚合逻辑，可作为 dashboard analytics API 的复用来源 |
| [/Users/shawn/workspace/coding/apex/src/web_assets.rs](/Users/shawn/workspace/coding/apex/src/web_assets.rs) | `embedded-web` 和文件系统双模式静态资源加载 |
| [/Users/shawn/workspace/coding/apex/Cargo.toml](/Users/shawn/workspace/coding/apex/Cargo.toml) | `embedded-web` feature 定义 |
| [/Users/shawn/workspace/coding/apex/docs/current/reference/release-model.md](/Users/shawn/workspace/coding/apex/docs/current/reference/release-model.md) | 当前发布模型：先构建 `target/web`，再用 `--features embedded-web` 打包 |
| [/Users/shawn/workspace/coding/apex/web/tests/dashboard.spec.ts](/Users/shawn/workspace/coding/apex/web/tests/dashboard.spec.ts) | 当前 dashboard E2E 回归覆盖模式 |
| [/Users/shawn/workspace/coding/apex/_bmad-output/planning/dashboard-page-structure-spec-2026-03-11.md](/Users/shawn/workspace/coding/apex/_bmad-output/planning/dashboard-page-structure-spec-2026-03-11.md) | 现有 dashboard 结构建议，便于识别与新需求冲突点 |
...
- [ ] Task 1: 建立新的 dashboard 页面骨架与组件边界
  - File: `/Users/shawn/workspace/coding/apex/web/src/components/dashboard/dashboard-client.tsx`
...
- [ ] Task 2: 补齐 dashboard 所需的 UI primitives 和业务容器
  - File: `/Users/shawn/workspace/coding/apex/web/src/components/ui/tabs.tsx`
...
- [ ] Task 3: 新增 dashboard 业务组件目录结构
  - File: `/Users/shawn/workspace/coding/apex/web/src/components/dashboard/`
...
- [ ] Task 6: 先定义 dashboard analytics API contract 与共享字段
  - File: `/Users/shawn/workspace/coding/apex/src/server.rs`
...
- [ ] Task 8: 复用数据库 analytics 聚合能力并补足缺口
  - File: `/Users/shawn/workspace/coding/apex/src/database.rs`
...
- [ ] Task 9: 评估并抽取 MCP analytics 的复用逻辑
  - File: `/Users/shawn/workspace/coding/apex/src/mcp/analytics.rs`
...
- [ ] Task 10: 在 Overview tab 接入 KPI、双轴趋势图与流量拓扑图
  - File: `/Users/shawn/workspace/coding/apex/web/src/components/dashboard/overview-tab.tsx`
...
- [ ] Task 11: 在 Team/System/Model tabs 接入剩余分析图表
  - File: `/Users/shawn/workspace/coding/apex/web/src/components/dashboard/team-usage-tab.tsx`
  - Action: 实现 Team Leaderboard 与 Model Usage by Team。
  - Notes: 团队排行按 tokens 排序，模型分布采用堆叠柱状图，必须受全局 filters 影响。
  - File: `/Users/shawn/workspace/coding/apex/web/src/components/dashboard/system-reliability-tab.tsx`
  - Action: 实现 Error Rate Trend 与 Channel Latency Comparison。
  - Notes: 错误率曲线与 Overview 指标口径一致；渠道延迟需要展示均值，必要时预留 p95 tooltip。
  - File: `/Users/shawn/workspace/coding/apex/web/src/components/dashboard/model-router-tab.tsx`
  - Action: 实现 Model Share 饼图与必要的 router/channel 补充摘要。
  - Notes: 悬浮态要显示真实值与占比，不只是颜色块。

- [ ] Task 12: 重构 Records tab 并保留现有可操作能力
  - File: `/Users/shawn/workspace/coding/apex/web/src/components/dashboard/records-tab.tsx`
...
- [ ] Task 13: 更新主题与视觉层
  - File: `/Users/shawn/workspace/coding/apex/web/src/app/globals.css`
  - Action: 调整全局变量与 dashboard 局部样式，使其符合 Slate/Emerald/Orange 的视觉方向，并兼容现有组件变量体系。
  - Notes: 不要求重建完整设计系统，但要避免当前实现与新 dashboard 视觉语言冲突。

- [ ] Task 14: 扩展前端回归测试
  - File: `/Users/shawn/workspace/coding/apex/web/tests/dashboard.spec.ts`
