...
files_to_modify:
  ...
  - '/Users/shawn/workspace/coding/apex/web/src/components/dashboard/types.ts'
  - '/Users/shawn/workspace/coding/apex/web/src/components/dashboard/overview-tab.tsx'
  - '/Users/shawn/workspace/coding/apex/web/tests/dashboard.spec.ts'
  - '/Users/shawn/workspace/coding/apex/web/tests/dashboard.backend.spec.ts'
code_patterns:
...
| File | Purpose |
| ---- | ------- |
| `/Users/shawn/workspace/coding/apex/web/src/components/dashboard/overview-tab.tsx` | 当前 Sankey 图、自定义节点、自定义链路、tooltip 的主要实现位置 |
| `/Users/shawn/workspace/coding/apex/web/src/components/dashboard/types.ts` | dashboard analytics 返回类型定义，包括 topology nodes、links、flows |
| `/Users/shawn/workspace/coding/apex/src/server.rs` | topology 聚合构建逻辑，决定前端可用的节点、链路和 flow 字段 |
| `/Users/shawn/workspace/coding/apex/web/tests/dashboard.spec.ts` | dashboard 前端行为测试基线 |
| `/Users/shawn/workspace/coding/apex/web/tests/dashboard.backend.spec.ts` | dashboard 后端联通与页面展示测试基线 |
| `/Users/shawn/workspace/coding/apex/web/package.json` | 确认 web 技术栈与测试工具版本，包括 Next.js、React、Recharts、Playwright |
...
- [x] Task 2: 同步前端 topology 类型定义
  - File: `/Users/shawn/workspace/coding/apex/web/src/components/dashboard/types.ts`
...
- [x] Task 7: 评估并按需补充真实后端冒烟覆盖
  - File: `/Users/shawn/workspace/coding/apex/web/tests/dashboard.backend.spec.ts`
