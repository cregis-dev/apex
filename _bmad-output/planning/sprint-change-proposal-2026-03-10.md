...
| 文件 | 修改内容 | 状态 |
|------|----------|------|
| `docs/current/reference/api-contracts.md` | 更新 MCP API 合同，新增 Streamable HTTP 说明 | 已完成 |
| `docs/current/architecture/backend.md` | 更新架构图和传输流程说明 | 已完成 |
| `docs/current/guides/operations.md` | 更新部署和客户端连接指南 | 已完成 |
...
- Apex Gateway PRD: `_bmad-output/planning/prd.md`
- Apex Architecture: `docs/current/architecture/backend.md`
