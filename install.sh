...
echo ""
echo "前台运行：APEX_CONFIG=$TARGET_DIR/config.json $TARGET_DIR/apex gateway run"
echo "服务安装：$TARGET_DIR/apex -c $TARGET_DIR/config.json service install --install-dir $TARGET_DIR"
